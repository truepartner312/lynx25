...
UniValue blockheaderToJSON(const CBlockIndex* tip, const CBlockIndex* blockindex)
{
    ...
    obj.pushKV("proof-of-work", GetDifficulty(blockindex));
    obj.pushKV("proof-of-stake", GetDifficulty(GetLastPoSBlockIndex(blockindex)));
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    ret_all.pushKV("subsidy", GetBlockSubsidy(pindex.nHeight, chainman.GetParams().GetConsensus(), pindex.pprev->GetBlockHash()));
